...
public class TouchInterceptor extends ListView {
	...
	public TouchInterceptor(Context context, AttributeSet attrs) {
		...
		mItemHeightNormal = 80;// res.getDimensionPixelSize(R.dimen.normal_height);
		mItemHeightHalf = mItemHeightNormal / 2;
		mItemHeightExpanded = 160;// res.getDimensionPixelSize(R.dimen.expanded_height);
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		if (mDragListener != null || mDropListener != null) {
			...
			case MotionEvent.ACTION_DOWN:
				...
				View dragger = item.findViewById(R.id.ll_item_add);// TODO
				Rect r = mTempRect;
				dragger.getDrawingRect(r);
				// The dragger icon itself is quite small, so pretend the touch
				// area is bigger
				if (x < r.right * 2) {
