...
*/
public class HistorySearchDao extends AbstractDao<HistorySearch, Void> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, HistorySearch entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(HistorySearch entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(HistorySearch entity) {
        return null;
    }
