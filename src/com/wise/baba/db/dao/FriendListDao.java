...
/** 
 * DAO for table FRIEND_LIST.
*/
public class FriendListDao extends AbstractDao<FriendList, Void> {

    public static final String TABLENAME = "FRIEND_LIST";

    /**
     * Properties of entity FriendList.<br/>
    ...
    */
    ...
    public FriendListDao(DaoConfig config) {
        super(config);
    }
    
    public FriendListDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'FRIEND_LIST' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'FRIEND_LIST'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, FriendList entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public FriendList readEntity(Cursor cursor, int offset) {
        FriendList entity = new FriendList( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, FriendList entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(FriendList entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(FriendList entity) {
        return null;
    }
