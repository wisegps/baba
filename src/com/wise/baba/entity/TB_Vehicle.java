...
public class TB_Vehicle {
	...
	public String toString() {
		return "TB_Vehicle [id=" + id + ", Cust_id=" + Cust_id + ", obj_id="
				+ obj_id + ", obj_name=" + obj_name + ", car_brand="
				+ car_brand + ", car_series=" + car_series + ", car_type="
				+ car_type + ", engine_no=" + engine_no + ", frame_no="
				+ frame_no + ", insurance_company=" + insurance_company
				...
				+ ", buy_date=" + buy_date + ", reg_no=" + reg_no
				+ ", vio_location=" + vio_location + ", device_id=" + device_id
				+ ", serial=" + serial + ", maintain_last_date="
				+ maintain_last_date + ", car_brand_id=" + car_brand_id
				+ ", car_series_id=" + car_series_id + ", car_type_id="
				+ car_type_id + ", vio_city_name=" + vio_city_name
				+ ", insurance_tel=" + insurance_tel + ", maintain_tel="
				+ maintain_tel + ", gas_no=" + gas_no + ", Content=" + Content
				+ "]";
	}	
}
