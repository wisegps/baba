...
public class OssUploadUtil {
	private static OssUploadUtil uploadUtil;
...
//					dos.flush();
			...
			Log.i(TAG, params);
			String content_md5 = "form-data; name=\"" + fileKey + "\"; filename=\"" + file.getName() + "\"";
			Date now = new Date(); 
			String signData = "PUT\n" + 
					GetSystem.getM5DEndo(content_md5) + 
					"\nimage/jpg\n" + 
					now.toGMTString();
			String Signature = hmac_sha("iAxAHoAuG1ZYwjIRLfyYKK2oF9WcCe", signData);
			//dos.write(params.getBytes());
			dos.write(("Authorization:OSS eJ3GLV07j9DD4LY5: " + Signature).getBytes());
			/**上传文件*/
...
//			dos.write(tempOutputStream.toByteArray());
	...
	private String hmac_sha(String key, String datas) {
		String reString = "";
		try {
